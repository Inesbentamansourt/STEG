...
<?php
 ...
 if (isset($_POST['button']))    
 {
    ...
    $email = $cnx->quote($_POST['email']);
    $tel = $_POST['tel'];
    $pass = $cnx->quote($_POST['pass']);
	$role = $cnx->quote($_POST['role']);   
    $sql = "INSERT INTO user  (name,prenom,email,tel,motdepasse,role) VALUES ($nom, $prenom,$email,$tel,$pass,$role)";
    $cnx->exec($sql);
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card">
                        <div class="card-body">
                                <h4 class="card-title">ajouter un membre
                                </h4>
                                <form  method='post' >
                                <div class="form-body">
                                    <div class="card-body">
                                        <div class="row pt-3">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input name="nom" type="text" id="firstName" class="form-control">
                                                  </div>
                                            </div>
                                            <!--/span-->
                                            <div class="col-md-6">
                                                <div class="form-group has-danger">
                                                    ...
                                                    <input name="prenom" type="text" id="lastName" class="form-control form-control-danger" >
                                                   </div>
                                            </div>
                                            <!--/span-->
                                        </div>
                                        ...
                                        <div class="row pt-3">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input name="email" type="text" id="firstName" class="form-control">
                                                  </div>
                                            </div>
                                            <!--/span-->
                                            <div class="col-md-6">
                                                <div class="form-group has-danger">
                                                    ...
                                                    <input name="tel" type="text" id="lastName" class="form-control form-control-danger">
                                                   </div>
                                            </div>
                                            <!--/span-->
                                        </div>
                                         ...
                                         <div class="row pt-3">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input name="pass" type="text" id="firstName" class="form-control">
                                                  </div>
                                            </div>
                                            <!--/span-->
                                            <div class="col-md-6">
                                    ...
                                    <div class="form-actions">
                                        <div class="card-body">
                                            <button name='button' type="submit" class="btn btn-success"> <i class="fa fa-check"></i> Enregister</button>
                                        </div>
                                    </div>
                                </div>
                                </form>
